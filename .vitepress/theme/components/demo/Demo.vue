...
onMounted(() => {
  new TypeIt(block.value, {
    ...
    .type('<br><span class="token title"># 歡迎使用 Slidev！</span><br><br>', { delay: 400 })
    .type('為開發者設計的簡報投影片', { delay: 400 })
    .move('START', { speed: 0 })
    .type('<br>')
    .move('START')
    .exec(pause)
    ...
    .type('<span class="token title"># 第 2 頁</span><br><br>', { delay: 400 })
    .type('- 📄 在單個 Markdown 檔案中撰寫投影片<br>', { delay: 800 })
    .type('- 🌈 主題、程式碼區塊、可互動元件<br>', { delay: 800 })
    .type('- 😎 閱讀說明文件來深入了解！', { delay: 800 })
